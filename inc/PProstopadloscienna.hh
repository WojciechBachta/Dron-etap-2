#ifndef PROSTOPADLOSCIENNA_HH
#define PROSTOPADLOSCIENNA_HH
#include "Przeszkoda.hh"

#include <iostream>

class PProstopadloscienna : public Przeszkoda
{
     double szerokosc; double dlugosc; double wysokosc;
    public:
PProstopadloscienna(double szerokosc, double dlugosc, double wysokosc)
{
   Wierz.resize(8);
